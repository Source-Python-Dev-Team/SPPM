...
class SubPluginReleaseTestCase(TestCase):
    def test_model_inheritance(self):
        self.assertTupleEqual(
            tuple1=SubPluginRelease.__bases__,
            tuple2=(ProjectRelease,),
        )

    def test_field_names(self):
        self.assertSetEqual(
            set1=get_new_fields_for_model(SubPluginRelease),
            set2={
                "sub_plugin",
                "created_by",
    ...
    def test_meta_class(self):
        ...
        self.assertTupleEqual(
            tuple1=getattr(SubPluginRelease._meta, "unique_together"),
