...
class SubPluginReleaseDownloadRequirementTestCase(TestCase):
    def test_model_inheritance(self):
        self.assertTupleEqual(
            tuple1=SubPluginReleaseDownloadRequirement.__bases__,
            tuple2=(AbstractUUIDPrimaryKeyModel,),
        )

    def test_field_names(self):
        self.assertSetEqual(
            set1=get_new_fields_for_model(SubPluginReleaseDownloadRequirement),
            set2={
                "sub_plugin_release",
    ...
    def test_meta_class(self):
        self.assertTupleEqual(
            tuple1=getattr(
                SubPluginReleaseDownloadRequirement._meta,
                "unique_together",
            ),
