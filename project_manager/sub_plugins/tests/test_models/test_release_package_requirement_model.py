...
class SubPluginReleasePackageRequirementTestCase(TestCase):
    def test_model_inheritance(self):
        self.assertTupleEqual(
            tuple1=SubPluginReleasePackageRequirement.__bases__,
            tuple2=(AbstractUUIDPrimaryKeyModel,),
        )

    def test_field_names(self):
        self.assertSetEqual(
            set1=get_new_fields_for_model(SubPluginReleasePackageRequirement),
            set2={
                "sub_plugin_release",
                "package_requirement",
                "version",
    ...
    def test_meta_class(self):
        self.assertTupleEqual(
            tuple1=getattr(
                SubPluginReleasePackageRequirement._meta,
                "unique_together",
            ),
