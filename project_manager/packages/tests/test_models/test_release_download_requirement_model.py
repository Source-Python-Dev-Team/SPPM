...
class PackageReleaseDownloadRequirementTestCase(TestCase):
    def test_model_inheritance(self):
        self.assertTupleEqual(
            tuple1=PackageReleaseDownloadRequirement.__bases__,
            tuple2=(AbstractUUIDPrimaryKeyModel,),
        )

    def test_field_names(self):
        self.assertSetEqual(
            set1=get_new_fields_for_model(PackageReleaseDownloadRequirement),
            set2={
                "package_release",
    ...
    def test_meta_class(self):
        self.assertTupleEqual(
            tuple1=getattr(
                PackageReleaseDownloadRequirement._meta,
                "unique_together",
            ),
