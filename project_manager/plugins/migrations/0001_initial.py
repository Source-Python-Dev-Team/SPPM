    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contributors', models.ManyToManyField(related_name='plugin_contributions', to='users.ForumUser')),
                ('download_requirements', models.ManyToManyField(related_name='required_in_plugins', to='requirements.DownloadRequirement')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plugins', to='users.ForumUser')),
                ('package_requirements', models.ManyToManyField(related_name='required_in_plugins', to='packages.Package')),
                ('pypi_requirements', models.ManyToManyField(related_name='required_in_plugins', to='requirements.PyPiRequirement')),
                ('supported_games', models.ManyToManyField(related_name='plugins', to='games.Game')),
                ('tags', models.ManyToManyField(related_name='plugins', to='tags.Tag')),
                ('vcs_requirements', models.ManyToManyField(related_name='required_in_plugins', to='requirements.VersionControlRequirement')),
            ],
            options={
                'abstract': False,
            },
