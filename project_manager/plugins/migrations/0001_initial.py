    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('download_requirements', models.ManyToManyField(related_name='plugins', to='requirements.DownloadRequirement')),
                ...
                ('vcs_requirements', models.ManyToManyField(related_name='plugins', to='requirements.VersionControlRequirement')),
            ],
            options={
                'abstract': False,
            },
